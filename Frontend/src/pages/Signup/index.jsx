...
export default function Signup() {
  ...
  async function fetchLocations(location) {
    axios
      .get(
        `https://trip-tide.onrender.com/api/common/get-coordinates?location=${location}`
      )
      .then((response) => {
  ...
  async function signup() {
    axios
      .post("https://trip-tide.onrender.com/api/user/signup", {
        email,
        password,
        firstName,
        lastName,
  ...
  clearOnEscape
  className="autocomplete-field" // Use the specific class for Autocomplete
  onInput={(event) => {
